...
install_xcframework "${PODS_ROOT}/ECPayPaymentGatewayKit/ECPayPaymentGatewayKit.xcframework" "ECPayPaymentGatewayKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
