...
//    var delegate: BaseViewController?
    ...
    let oldPasswordTxt2: MainTextField2 = {
        let view: MainTextField2 = MainTextField2(key: "oldpassword", label: "舊密碼", icon: "password_svg", placeholder: "舊密碼", isRequired: true, isPassword: true)
        
        return view
    }()
    
    let newPasswordTxt2: MainTextField2 = {
        let view: MainTextField2 = MainTextField2(key: "newpassword", label: "新密碼", icon: "password_svg", placeholder: "新密碼", isRequired: true, isPassword: true)
        
        return view
    }()
    
    let rePasswordTxt2: MainTextField2 = {
        let view: MainTextField2 = MainTextField2(key: "repassword", label: "密碼確認", icon: "password_svg", placeholder: "新密碼確認", isRequired: true, isPassword: true)
