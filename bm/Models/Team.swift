...
//    var data:Dictionary<String, [String: Any]> = Dictionary<String, [String: Any]>()
    ...
    func initData() {
        ...
        data2 = [
            TEAM_NAME_KEY:["ch":"名稱","vtype":"String","value":"","submit":true,"atype":none,"show":"","keyboardType":defaultPad,"text_field":true],
            TEAM_LEADER_KEY:["ch":"聯絡人","vtype":"String","value":"","submit":true,"atype":none,"show":"","keyboardType":defaultPad,"text_field":true],
            TEAM_MOBILE_KEY:["ch":"電話","vtype":"String","value":"","submit":true,"atype":none,"show":"","keyboardType":phonePad,"text_field":true],
