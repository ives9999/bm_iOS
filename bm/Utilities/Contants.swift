...
// URL Constants
let REMOTE_BASE_URL = "https://api.sportpassword.com"
...
let LOCALHOST_BASE_URL = "http://api.sportpassword.localhost"
...
let URL_ARENA_LIST = "\(URL_HOME)arena/getRead"
let URL_ARENA_ONE = "\(URL_HOME)arena/getOne"
...
let URL_CHANGE_PASSWORD = "\(URL_HOME)member/change_password"
...
let URL_DEVICE_TOKEN = "\(URL_HOME)deviceToken"
...
let URL_FORGET_PASSWORD = "\(URL_HOME)member/forget_password"
let URL_HOME = "\(BASE_URL)/"
...
let URL_MATCH_GROUP_LIST = "\(URL_HOME)match_group/list"
//let URL_MATCH_PLAYER_LIST = "\(URL_HOME)match_player/list"
let URL_MATCH_TEAM_LIST = "\(URL_HOME)match_team/list"
let URL_MATCH_GROUP_UPDATE = "\(URL_HOME)match_group/update"
let URL_MATCH_TEAM_PLAYER_LIST = "\(URL_HOME)match_team_player/list"
let URL_MATCH_TEAM_PLAYER_UPDATE = "\(URL_HOME)match_team_player/update"
let URL_MATCH_TEAM_UPDATE = "\(URL_HOME)match_team/update"
let URL_MATCH_UPDATE = "\(URL_HOME)match/update"
...
let URL_MEMBER_SUBSCRIPTION_KIND = URL_HOME + "member/subscriptionKind"
let URL_MEMBER_SUBSCRIPTION_LOG = URL_HOME + "member/subscriptionLog"
...
let URL_MEMBER_UNSUBSCRIPTION = URL_HOME + "member/unSubscription"
var URL_MEMBER_TEAM_DELETE = "\(URL_HOME)member/deleteMemberTeam"
let URL_MEMBER_TEAM_LIST = "\(URL_HOME)member/teamlist"
...
let URL_TEAM_LIST = "\(URL_HOME)team/getRead"
...
let URL_TEAM_MEMBER_ADD = "\(URL_HOME)team/addTeamMember"
let URL_TEAM_MEMBER_DELETE = "\(URL_HOME)team/deleteTeamMember"
let URL_TEAM_MEMBER_LEAVE = "\(URL_HOME)team/leave"
let URL_TEAM_MEMBER_LIST = "\(URL_HOME)team/teamMemberList"
let URL_TEAM_PLUSONE = BASE_URL + "/team/tempPlay/plusOne/"
let URL_TEAM_TEMP_PLAY_ADD = URL_TEAM + "tempPlay/add"
...
let TO_MEMBER_SUPSCRIPTION_KIND: String = "toMemberSubscriptionKind"
let TO_MEMBER_SUBSCRIPTION_LOG: String = "toMemberScriptionLog"
let TO_MEMBER_SUBSCRIPTION_PAY: String = "toMemberScriptionPay"
...
let MEMBER_LEVEL_BACKGROUND = "#3B3C43"
let MY_BLACK = "#000000"
let MY_GREEN = "#a6d903"
let MY_RED = "#f11b90"
...
let TEXT_DESC = "#90918F"
let TEXTGRAY = "#BFBFBF"
let TEXT_WHITE = "#d1d1d1"
let TEXT_WHITE40: UIColor = UIColor(hex: "#FFFFFF", alpha: 0.4)
...
let SUBSCRIPTION_KEY = "subscription"
